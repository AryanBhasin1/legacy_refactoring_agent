...
export default function ChatWindow({ session, addMessage, setSessionStatus }) {
  ...
  return (
    <div
      id="chat-window"
      className="flex h-full flex-col rounded-2xl border border-zinc-200 bg-white dark:bg-zinc-900 shadow-sm"
    >
      <div
      ...
      <div id="chat-window-composer" className="border-t border-zinc-200 p-4">
        <div className="relative">
          <textarea
            ...
            className="min-h-[84px] w-full resize-none rounded-2xl border border-zinc-300 px-4 py-3 pr-16 text-sm text-zinc-900 dark:text-zinc-300 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
          />
          <button
            onClick={handleSend}
            disabled={sending}
            className="absolute bottom-3 right-3 inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-zinc-900 text-white transition hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-50"
